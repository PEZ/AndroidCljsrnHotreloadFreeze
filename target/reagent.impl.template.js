...
var G__34923 = o;
goog.object.set(G__34923,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__34941__delegate = function (args){
...
while (G__34942__i < G__34942__a.length) {G__34942__a[G__34942__i] = arguments[G__34942__i + 0]; ++G__34942__i;}
  args = new cljs.core.IndexedSeq(G__34942__a,0,null);
} 
...
var args = cljs.core.seq(arglist__34943);
...
var G__34924 = o;
goog.object.set(G__34924,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__34944__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__34945__i < G__34945__a.length) {G__34945__a[G__34945__i] = arguments[G__34945__i + 0]; ++G__34945__i;}
  args = new cljs.core.IndexedSeq(G__34945__a,0,null);
} 
return G__34944__delegate.call(this,args);};
G__34944.cljs$lang$maxFixedArity = 0;
G__34944.cljs$lang$applyTo = (function (arglist__34946){
var args = cljs.core.seq(arglist__34946);
return G__34944__delegate(args);
});
...
var G__34925 = props;
var G__34925__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34925,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__34925);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34925__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__34926 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34926,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__34926;
}
})(),id_class);
...
var G__34927 = (cljs.core.count(argv) - first_child);
switch (G__34927) {
case (0):
...
var vec__34928 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34928,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34928,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34928,(2),null);
...
var temp__5757__auto___34950 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___34950 == null)){
} else {
var key_34951 = temp__5757__auto___34950;
(jsprops.key = key_34951);
}
...
var temp__5757__auto___34954 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___34954 == null)){
} else {
var key_34955 = temp__5757__auto___34954;
(jsprops.key = key_34955);
}
...
var temp__5757__auto___34958 = reagent.impl.util.react_key_from_vec(argv);
...
var temp__5757__auto___34961 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___34961 == null)){
} else {
var key_34963 = temp__5757__auto___34961;
(jsprops.key = key_34963);
}
...
var temp__5757__auto___34966 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___34966 == null)){
} else {
var key_34967 = temp__5757__auto___34966;
(jsprops.key = key_34967);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34931_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__34931_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__34932 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34932,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34932,(1),null);
...
break;
default:
var G__34972 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__34973 = compiler;
v = G__34972;
compiler = G__34973;
continue;
...
var G__34936 = tag;
var G__34936__$1 = (((G__34936 instanceof cljs.core.Keyword))?G__34936.fqn:null);
switch (G__34936__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template34938 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template34938 = (function (opts,id,fn_to_element,meta34939){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template34938.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_34940,meta34939__$1){
var self__ = this;
var _34940__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template34938(self__.opts,self__.id,self__.fn_to_element,meta34939__$1));
}));

(reagent.impl.template.t_reagent$impl$template34938.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_34940){
var self__ = this;
var _34940__$1 = this;
return self__.meta34939;
}));

(reagent.impl.template.t_reagent$impl$template34938.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template34938.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template34938.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template34938.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template34938.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta34939","meta34939",-525212187,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template34938.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template34938.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template34938");

(reagent.impl.template.t_reagent$impl$template34938.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write(writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template34938");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template34938.
 */
reagent.impl.template.__GT_t_reagent$impl$template34938 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template34938(opts__$1,id__$1,fn_to_element__$1,meta34939){
return (new reagent.impl.template.t_reagent$impl$template34938(opts__$1,id__$1,fn_to_element__$1,meta34939));
});

}

return (new reagent.impl.template.t_reagent$impl$template34938(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
